...
| `sensors/sbes` | `Altitude` (key: sensor_id 1-6) | SENSOR | 1–10 Hz | `oas_manager` (T1, 1 process, 6 instances) | NSS (sensor_id 1,2 only) + mnss/pcss (sensor_id 3-6) | **public** (not nss-internal — see §1.2) |
